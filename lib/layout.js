...
<title>${title} · Akro SchoolData-Hub</title>
...
<header class="site-header">
  <a class="brand" href="/"><img src="/logo-icon.png" alt="" class="brand-mark">Akro<span>SchoolData</span>-Hub</a>
  <nav class="site-nav">
...
<footer class="site-footer">
  <p>Akro SchoolData-Hub — student-run data &amp; airtime reselling. Text an order to <span class="mono">${process.env.SMS_SENDER_ID || "[your SMS short code]"}</span> or order on the web.</p>
  <p class="fine-print">Contact admin for Student ID 🆔 — <a href="tel:+233555816928">0555816928</a></p>
  <p class="fine-print">Created by Adegbe Hackman Junior · Electrical and Electronics Technology · Technical Department</p>
</footer>
</body>
</html>`;
}
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>${title} · Akro SchoolData-Hub Admin</title>
<link rel="icon" type="image/png" href="/favicon.png">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700&family=Inter:wght@400;500;600&family=IBM+Plex+Mono:wght@500&display=swap" rel="stylesheet">
<link rel="stylesheet" href="/style.css">
...
<div class="admin-shell">
  <aside class="admin-sidebar">
    <a class="admin-brand" href="/admin"><img src="/logo-icon.png" alt="" class="brand-mark">Akro<span>SchoolData</span>-Hub</a>
    <nav class="admin-nav">
