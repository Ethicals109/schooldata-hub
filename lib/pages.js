...
<section class="section">
  <h1>Admin</h1>
  <p class="lede">Welcome back — here's what needs your attention.</p>

  ${balanceBlock}

  <div class="quick-access-grid">
    <a href="/admin/orders" class="quick-access-card qa-orders">
      <span class="qa-icon">📦</span>
      <span class="qa-title">Orders</span>
      <span class="qa-sub">${stats.pendingOrders} awaiting action</span>
    </a>
    <a href="/admin/student-ids" class="quick-access-card qa-student-ids">
      <span class="qa-icon">🎫</span>
      <span class="qa-title">Student IDs</span>
      <span class="qa-sub">${stats.unassignedIds} left to issue</span>
    </a>
    <a href="https://dashboard.paystack.co" target="_blank" rel="noopener" class="quick-access-card qa-paystack">
      <span class="qa-icon">💳</span>
      <span class="qa-title">Paystack</span>
      <span class="qa-sub">View payments</span>
    </a>
    <a href="https://gigforless.com/dashboard" target="_blank" rel="noopener" class="quick-access-card qa-gigforless">
      <span class="qa-icon">🔌</span>
      <span class="qa-title">GigForLess</span>
      <span class="qa-sub">Fulfillment account</span>
    </a>
    <a href="#" class="quick-access-card qa-bundles disabled" onclick="return false;">
      <span class="qa-icon">📶</span>
      <span class="qa-title">Bundles &amp; pricing</span>
      <span class="qa-sub">Edit data/bundles.json</span>
    </a>
    <a href="#" class="quick-access-card qa-settings disabled" onclick="return false;">
      <span class="qa-icon">⚙️</span>
      <span class="qa-title">Settings</span>
      <span class="qa-sub">Coming soon</span>
    </a>
  </div>
...
<section class="section">
  ...
  <p class="lede"><a href="/admin">← Admin home</a> · Process orders here, then mark them done — this sends a confirmation SMS to the student. <a href="/admin/student-ids">Issue a Student ID →</a></p>
  <table class="orders-table">
...
<section class="section">
  ...
  <p class="lede"><a href="/admin">← Admin home</a> · Registration is invite-only: issue a Student ID to a specific student here, then hand it to them (or let the SMS below do it). They'll need it to register on the site — <a href="/register">/register</a> won't accept a code that hasn't been issued.</p>
